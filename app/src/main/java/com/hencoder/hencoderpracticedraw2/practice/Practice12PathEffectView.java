...
public class Practice12PathEffectView extends View {
    ...
    Path path = new Path();
    PathEffect pathEffect1 = new CornerPathEffect(30);
    PathEffect pathEffect2 = new DiscretePathEffect(10, 3);
...

    {
        ...
        path2.lineTo(15, -30);
        path2.lineTo(0, 0);
        pathEffect4 = new PathDashPathEffect(path2, 40, 0, PathDashPathEffect.Style.MORPH);
        pathEffect5 = new SumPathEffect(pathEffect2, pathEffect3);
        pathEffect6 = new ComposePathEffect(pathEffect2, pathEffect3);
    }
